XDP-ADC: Getting Started on Linux-based virtual machines or bare-metal
======================================================================

Getting started on Linux with XDP-ADC is as easy as running a Linux daemon program in your VM or machine. Once the daemon program is up and running, XDP-ADC is already protecting the system.
